...
namespace Programmers
{
    internal class 외계어_사전
    {
        ...
        //입출력 예 설명
        //입출력 예 #1
        //"p", "o", "s" 를 조합해 만들 수 있는 단어가 dic에 존재하지 않습니다.
        //따라서 2를 return합니다.

        //입출력 예 #2
        //"z", "d", "x" 를 조합해 만들 수 있는 단어 "dzx"가 dic에 존재합니다.
        //따라서 1을 return합니다.
        ...
        //유의사항
        //입출력 예 #3 에서 "moos", "smm", "som"도
        //"s", "o", "m", "d" 를 조합해 만들 수 있지만
        //spell의 원소를 모두 사용해야 하기 때문에 정답이 아닙니다.
        public int solution165(string[] spell, string[] dic)
        {
            int answer = 2;
