...
namespace Programmers
{
    internal class 뒤에서_5등_위로
    {
        ...
        public int[] solution101(int[] num_list)
        {
            int[] answer = new int[] { };
            List<int> li = new List<int>();
            List<int> li2 = new List<int>(num_list);
            li2 = li2.OrderBy(x => x).ToList();
            for (int i = 5;i <li2.Count; i++)
            {
                li.Add(li2[i]);
            }
            answer = li.ToArray();
