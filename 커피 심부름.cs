...
namespace Programmers
{
    internal class 커피_심부름
    {
        ...
        public int solution116(string[] order)
        {
            int answer = 0;
        ...
        //다른 사람 풀이
        //return Enumerable.Range(0, order.Length).Select(s => order[s].Contains("cafelatte") ? 5000 : 4500).Sum();
    }
}
