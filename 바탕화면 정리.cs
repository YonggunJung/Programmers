...
namespace ProgrammersLv1
{
    internal class 바탕화면_정리
    {
        ...
        //저장한 코드가 많아지면서 머쓱이는
        //본인의 컴퓨터 바탕화면이 너무 지저분하다고 생각했습니다.
        //프로그래머스에서 작성했던 코드는 그 문제에 가서
        //다시 볼 수 있기 때문에 저장해 둔 파일들을 전부 삭제하기로 했습니다.

        //컴퓨터 바탕화면은 각 칸이 정사각형인 격자판입니다.
        //이때 컴퓨터 바탕화면의 상태를 나타낸 문자열 배열 wallpaper가 주어집니다.
        //파일들은 바탕화면의 격자칸에 위치하고
        //바탕화면의 격자점들은 바탕화면의 가장 왼쪽 위를 (0, 0)으로
        //시작해(세로 좌표, 가로 좌표)로 표현합니다.
        ...
        //wallpaper[i][j] 는 바탕화면에서 i + 1행 j + 1열에
        //해당하는 칸의 상태를 나타냅니다.
        ...
        //따라서 가장 적은 이동의 드래그로 모든 파일을 선택하는
        //방법인[1, 3, 5, 8] 을 return합니다.
        ...
        public int[] solution62(string[] wallpaper)
        {
