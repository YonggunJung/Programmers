...
namespace ProgrammersLv2
{
    class 예상_대진표
    {
        ...
        //경쟁자로 생각하는 B번 참가자와 몇 번째 라운드에서 만나는지
        ...
        public int solution14(int n, int a, int b)
        {
            ...
            while(a != b)
            {
                if(Math.Ceiling(c/2) == Math.Ceiling(d / 2))
                {
                    answer++;
                    break;
                }
