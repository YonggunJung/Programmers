...
namespace ProgrammersLv1
{
    internal class 덧칠하기
    {
        ...
        //롤러의 길이가 4미터이므로 한 번의 페인트칠에
        //연속된 4개의 구역을 칠할 수 있습니다.
        //처음에 3, 4, 5, 6번 영역에 페인트칠을 하면
        //칠해야 할 곳으로 2번 구역만 남고
        //1, 2, 3, 4번 구역에 페인트칠을 하면 2번 만에
        //다시 칠해야 할 곳에 모두 페인트칠을 할 수 있습니다.
        //img1.png
        ...
        public int solution52(int n, int m, int[] section)
        {
            // 점점 머리쓰는게 느껴짐 ㅋㅋㅋ
            int answer = 1;
            int s = section[0];
